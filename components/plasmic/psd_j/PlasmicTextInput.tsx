...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: _Qbmz7EISRz_/css

import SearchSvgIcon from "./icons/PlasmicIcon__SearchSvg"; // plasmic-import: iCsg8uIR7ASS/icon
import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: ERbvdfgpax4A/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__lKrSh)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__q9Zfm)}
              role={"img"}
            />
          ),
